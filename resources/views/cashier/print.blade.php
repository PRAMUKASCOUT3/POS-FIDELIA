        ...
        <div class="card" style="width: 30rem">
            <div class="card-body">
                <div class="d-flex justify-content-center align-items-center">
                    <img src="/assets/img/JOJO.png" alt="Logo" style="width: 70px;">
                    <h4 class="text-center flex-grow-1" style="margin-right:60px">Struk Pembayaran</h4>
                </div>
                <div class="text-center">
                    <h5 style="margin-top:-20px">Jojo Petshop</h5>
                    <p>Marene, Kel. Ekajaya, Kec. Paal Merah</p>
                </div>
