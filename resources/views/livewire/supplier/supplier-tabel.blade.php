                                    ...
                                    <tr> 
                                        ...
                                        <td> 
                                            <div class="d-flex justify-content-center"> 
                                                <a href="{{ route('supplier.edit', $supplier->id) }}" class="btn btn-info btn-sm me-2">Edit</a> 
                                                <form id="deleteForm{{ $supplier->id }}" class="d-inline" action="{{ route('supplier.delete', $supplier->id) }}" method="post"> 
                                                    @csrf 
                                                    @method('delete') 
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $supplier->id }})">Hapus</button> 
                                                </form> 
                                            </div> 
                                        </td> 
                                    </tr> 
